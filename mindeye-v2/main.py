...
# import sgm
from model.modules import FrozenOpenCLIPImageEmbedder # bigG embedder
...
if utils.is_interactive(): # set batch size here if using interactive notebook instead of submitting job
    ...
    global_batch_size = 8 #os.environ["GLOBAL_BATCH_SIZE"]
    batch_size = 8 // num_devices
    # batch_size = 8# int(os.environ["GLOBAL_BATCH_SIZE"]) // num_devices
...
if utils.is_interactive():
    ...
    # /home/aa2793/project/aria/InnerSight/sota/mindeye_v2/MindEyeV2/src
    # global_batch_size and batch_size should already be defined in the 2nd cell block
    # jupyter_args = f"--data_path=/weka/proj-medarc/shared/mindeyev2_dataset \
    jupyter_args = f"--data_path=/home/aa2793/gibbs/arman/datasets/NEUROSCIENCE/NSD-MINDEYE-V2 \
                    --cache_dir=/home/aa2793/gibbs/arman/datasets/NEUROSCIENCE/NSD-MINDEYE-V2 \
...
parser.add_argument(
    "--data_path", type=str, default='/home/aa2793/gibbs/arman/datasets/NEUROSCIENCE/NSD-MINDEYE-V2',
    help="Path to where NSD data is stored / where to download it to",
)
parser.add_argument(
    "--cache_dir", type=str, default='/home/aa2793/gibbs/arman/datasets/NEUROSCIENCE/NSD-MINDEYE-V2',
...
parser.add_argument(
    "--num_epochs",type=int,default=15,  # default=150
...
if blurry_recon:
    ...
    from model.convnext import ConvnextXL
...
for epoch in progress_bar:
    ...
    for s, train_dl in enumerate(train_dls):
        with torch.amp.autocast(dtype=data_type, device_type='cuda'):
            iter = -1
    ...
    model.eval()
    if local_rank==0:
        with torch.no_grad(), torch.amp.autocast(dtype=data_type, device_type='cuda'): 
